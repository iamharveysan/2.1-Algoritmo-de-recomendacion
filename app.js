...
// =====================
const SHEETS_API_URL = "https://script.google.com/macros/s/AKfycbybZ-h9_PSP35BMz3mH48goByUcmGwM9dRpOjA19oCyYmWG7WLSMU8DbVEvJRVAMBnJ/exec";

// Ejecuta todo cuando el DOM ya exista (evita nulls en getElementById)
window.addEventListener("DOMContentLoaded", () => {
  ...
  function sendVoteToSheets({ segmento, contexto, cursoA, cursoB, ganador, perdedor }) {
    // No-cors: el navegador no deja leer respuesta, pero Sheets sí recibe.
    fetch(SHEETS_API_URL, {
      ...
      body: JSON.stringify({ segmento, contexto, cursoA, cursoB, ganador, perdedor })
